 ...
 */
public class ClientRegistrationViaMainPageTest extends BaseTest{

    @Test
    public void ClientRegistrationViaMainPage_Test() throws Exception {

        Properties props = propertyXMLoader(System.getProperty("user.dir") +
                "\\src\\main\\java\\tests\\TestDataXML\\Registration\\ClientRegistrationViaMainPageTest.xml");
